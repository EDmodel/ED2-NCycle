...
!  real                 , dimension((FSN_ndays_to_avg-1),huge_cohort)       :: N_limitation_factor !JL!
            ...
            do isi = 1,cpoly%nsites
               ...
               do ip=1,npatches
                  ...
                  if (sitenum(ip) == cpoly%sitenum(isi)) then
                     ...
                     !csite%fsc_in_no_excess (ip2) = fsc (ip) !JL i dont think this applies to this variable !
         ...
         case default
            ...
            do isi = 1, cpoly%nsites
               ...
               do ip=1,npatches
                 ...
                 !csite%fsc_in_no_excess (ip) = fsc (ip) !JL 

...
subroutine compute_budget(csite,lsl,pcpg,qpcpg,ipa,wcurr_loss2atm,ecurr_loss2atm           &
   ...
   !---------------------------------------------------------------------------------------!
 ! print*, 'wcurr_precipgain 1',   wcurr_precipgain,'pcpg',pcpg, 'dtlsm', dtlsm JL

   wcurr_precipgain = pcpg  * dtlsm
   ecurr_precipgain = qpcpg * dtlsm
  !print*, 'wcurr_precipgain BUDGET_UTILS',   wcurr_precipgain,'pcpg',pcpg, 'dtlsm', dtlsm
...
!   print*, 'csite%wbudget_precipgain(ipa) 3',   csite%wbudget_precipgain(ipa) JL

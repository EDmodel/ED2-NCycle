...
!------------------------------------------------------------------------------------------!
subroutine read_met_driver_head(my_ens,my_real)
   ...
   !---------------------------------------------------------------------------------------!
   integer, intent(in) :: my_ens, my_real
...
!   write(new_name,'(2a,i1.1,3a)')trim(met_names(2)),'e',my_ens,'/',trim(post),'/africa_OL2_'
!   met_names(2) = trim(new_name)

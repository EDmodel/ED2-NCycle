...
pn1=pn1+csite%area(ipa)*cpatch%nplant(ico)*(cpatch%balive(ico)/c2n_leaf(cpatch%pft(ico))+cpatch%bdead(ico)/c2n_stem(cpatch%pft(ico))+ cpatch%nstorage(ico)+cpatch%bseeds(ico)*(1.0-seedling_mortality(cpatch%pft(ico)))/c2n_recruit(cpatch%pft(ico)))!JL added nstorage
enddo
...
pn2=pn2+csite%area(ipa)*cpatch%nplant(ico)*(cpatch%balive(ico)/c2n_leaf(cpatch%pft(ico))+cpatch%bdead(ico)/c2n_stem(cpatch%pft(ico)) + cpatch%nstorage(ico))
 !JL added nstorage
